  ...
  export default function PermitListScreen({ navigation }) {
    ...
    const handleNext = () => {
      ...
      if (Object.values(checklist).some(item => item)) {
        navigation.navigate('Permitlist2'); 
      } else {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <Text style={styles.subHeaderText}>
          The following will be used during the works and are in good working condition
        </Text>
          ...
          {Object.keys(checklist).map((item, index) => (
            <View key={index} style={styles.checklistItem}>
              ...
              <CheckBox
                ...
                color={checklist[item] ? '#66C05D' : '#A3D59B'} // Customize checkbox colors
